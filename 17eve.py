...
def login_page():
    ...
    with col1:
        st.markdown("<h3 style='text-align: center; color: #2d3748; margin-bottom: 2rem;'>🔐 Secure Login</h3>", 
                    unsafe_allow_html=True)
    ...
    with col2:
        ...
        st.image(
            r"Z:\bioattendance\images\system_overview.png",
            width=400,
...
def admin_dashboard():
    ...
    menu = st.sidebar.selectbox(
        "Menu",
        ["Home", "QR Attendance","User Management", "Attendance Management", "Leave Management", "Reports", "Project Reports", "Salary Management", "Employee Directory","Admin Directory","Admin Biometric Setup", 
         "Settings"],index=["Home","QR Attendance", "User Management", "Attendance Management","Leave Management","Reports","Project Reports", "Salary Management",  "Employee Directory","Admin Directory","Admin Biometric Setup", "Settings"].index(
